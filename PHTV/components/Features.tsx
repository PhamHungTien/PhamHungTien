...
const FeatureCard: React.FC<FeatureProps> = ({ icon: Icon, title, description, color = "text-brand-400" }) => (
  <div className="glass-panel p-8 rounded-[2rem] hover:bg-white/5 transition-all duration-500 border border-white/5 hover:border-brand-500/20 group h-full flex flex-col relative overflow-hidden shadow-none">
