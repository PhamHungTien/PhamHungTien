...
export const AcronymRow = ({ letter, word }: { letter: string, word: string }) => (
  <div className="flex items-center group/row cursor-default select-none relative h-[28px] sm:h-[44px] md:h-[64px] overflow-visible pr-6 sm:pr-10 md:pr-16">
    ...
    <div className="w-10 sm:w-16 md:w-20 flex justify-end shrink-0 overflow-visible pr-1 sm:pr-2">
        <span className="text-3xl sm:text-5xl md:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-br from-rose-600 via-pink-400 to-red-600 bg-[length:200%_auto] animate-gradient-flow filter drop-shadow-[0_0_20px_rgba(225,29,72,0.6)] drop-shadow-[0_0_40px_rgba(220,38,38,0.3)] group-hover/row:drop-shadow-[0_0_30px_rgba(225,29,72,0.8)] group-hover/row:scale-110 transition-all duration-500 z-10 font-sans italic leading-none flex items-center h-full pr-2 md:pr-3">
        {letter}
        </span>
    </div>
