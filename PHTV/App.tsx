        ...
        <div className="animate-in fade-in duration-1000">
          ...
          <main className="relative pt-32 pb-20 md:pt-56 md:pb-40 px-6 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto text-center relative z-10">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 mb-10 animate-in fade-in slide-in-from-bottom-4 duration-1000">
          ...
          <section id="install" className="reveal py-32 md:py-48 bg-slate-950/30 border-y border-white/5 scroll-mt-32 relative overflow-hidden">
            ...
            <div className="max-w-5xl mx-auto px-6 relative z-10">
              <div className="text-center mb-24">
                <h2 className="text-4xl md:text-6xl font-black mb-8 text-white tracking-tighter italic">Cài đặt dễ dàng</h2>
                <p className="text-slate-400 text-xl md:text-2xl font-medium max-w-2xl mx-auto opacity-80">Hỗ trợ tuyệt vời cho macOS 13.0+ trên cả Intel và Apple Silicon.</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-24">
                <div className="glass-panel rounded-[2.5rem] p-10 md:p-12 flex flex-col shadow-3xl group relative overflow-hidden transition-all duration-500 hover:border-brand-500/30">
                   ...
                   <div className="flex items-center gap-5 mb-16">
                      ...
                      <h3 className="text-3xl font-black text-white tracking-tight">Homebrew</h3>
                   </div>
                   <div className="mb-8">
                   ...
                   <p className="text-slate-400 text-lg mb-10 leading-relaxed font-medium">Lựa chọn hàng đầu cho lập trình viên và những ai yêu thích sự gọn nhẹ của Terminal.</p>
                 ...
                 <div className="glass-panel rounded-[2.5rem] p-10 md:p-12 flex flex-col shadow-3xl group relative overflow-hidden transition-all duration-500 hover:border-brand-500/30">
                   ...
                   <div className="flex items-center gap-5 mb-16">
                      ...
                      <h3 className="text-3xl font-black text-white tracking-tight">Tải trực tiếp</h3>
                   </div>
                   ...
                   <div className="p-8 bg-yellow-500/[0.03] border border-yellow-500/10 rounded-3xl backdrop-blur-md">
                     <div className="flex items-start gap-5">
                        <div className="p-3 bg-yellow-500/10 rounded-2xl"><Icons.Shield className="text-yellow-500 shrink-0" size={24} /></div>
                        <div className="text-sm md:text-base">
                          <strong className="text-yellow-500 font-black block mb-2 uppercase tracking-widest text-xs">Mẹo bảo mật</strong>
                          <span className="text-slate-400 leading-relaxed font-medium italic opacity-80">Nếu macOS thông báo "App is damaged", hãy chạy lệnh này:</span>
              ...
              <div className="glass-panel rounded-[3rem] p-12 md:p-16 max-w-4xl mx-auto border border-white/10 shadow-[0_40px_100px_rgba(0,0,0,0.4)] backdrop-blur-2xl">
                 <h3 className="text-3xl font-black text-white mb-12 text-center flex items-center justify-center gap-4 uppercase tracking-tighter italic"><Icons.CheckCircle2 className="text-green-500" /> Hoàn tất cài đặt</h3>
                 <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    {[ 
                      ...
                      <div key={i} className="flex flex-col items-center text-center group/step">
                        <div className="w-16 h-16 rounded-full bg-white/5 border border-white/10 flex items-center justify-center mb-6 text-brand-400 shadow-xl transition-all duration-500 group-hover/step:bg-brand-500 group-hover/step:text-white group-hover/step:scale-110 group-hover/step:rotate-6"><step.icon size={32} /></div>
