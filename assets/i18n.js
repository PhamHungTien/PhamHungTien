(function () {
  const DICTIONARY = {
    vi: {
      ...
      "root.nav_products": "Sản phẩm",
      "root.hero_eyebrow": "PHAM HUNG TIEN · APPLE SOFTWARE",
      "root.hero_title": "Những ứng dụng nhỏ, làm nên khác biệt mỗi ngày.",
      "root.explore": "Khám phá sản phẩm",
      "root.hero_contact": "Nói chuyện cùng mình",
      "root.stat_products": "sản phẩm",
      "root.stat_platforms": "nền tảng Apple",
      "root.stat_care": "sự chăm chút",
      "root.featured_label": "MỚI & NỔI BẬT",
      "root.products_eyebrow": "BỘ SƯU TẬP",
      "root.products_title": "Chọn công cụ phù hợp với nhịp làm việc của bạn.",
      "root.products_desc": "Mỗi sản phẩm bắt đầu từ một vấn đề thường gặp — rồi được làm cho đơn giản, nhanh và dễ chịu hơn.",
      "root.view_product": "Xem sản phẩm <span aria-hidden=\"true\">↗</span>",
      "root.category_utility": "TIỆN ÍCH",
      "root.category_calendar": "LỊCH & TIỆN ÍCH",
      "root.category_macos": "macOS",
      "root.category_developer": "DÀNH CHO LẬP TRÌNH",
      "root.category_productivity": "NĂNG SUẤT",
      "root.category_game": "TRÒ CHƠI",
      "root.contact_eyebrow": "KẾT NỐI",
      "root.contact_title": "Có một ý tưởng đang cần thành ứng dụng?",
      "root.contact_desc": "Mình luôn hứng thú với những sản phẩm gọn gàng, hữu ích và được làm tử tế.",
      "root.get_in_touch": "Liên hệ",
      "root.visit_github": "Xem GitHub",
      ...
      "mynasmanager.download_btn": "Tải về trên App Store",
      ...
      "padnotesai.download_btn": "Tải trên App Store",
      ...
      "padnotesai.platforms": "Nền tảng",
      "padnotesai.execution": "Xử lý",
      "padnotesai.on_device": "Nhận dạng offline",
      "padnotesai.support": "Hỗ trợ",
      "padnotesai.support_title": "Hỗ trợ & Liên hệ",
      "padnotesai.support_desc": "Bạn có câu hỏi hoặc cần hỗ trợ kỹ thuật cho ứng dụng Pad Notes AI? Hãy liên hệ qua email:",
      "padnotesai.features_kicker": "Tính năng",
      "padnotesai.features_title": "Sổ tay kỹ thuật số thế hệ mới.",
      "padnotesai.features_desc": "Viết tay, lưu trữ âm thoại và phân tích tài liệu trực quan từ bất cứ đâu.",
      "padnotesai.feat1_title": "Smart Handwritings",
      "padnotesai.feat1_desc": "Hỗ trợ vẽ viết tay chuyên sâu bằng Pencil với đầy đủ cọ vẽ, bảng màu và mẫu giấy.",
      "padnotesai.feat2_title": "Local Handwriting OCR",
      "padnotesai.feat2_desc": "Quét và chuyển đổi các nét vẽ viết tay thành văn bản kỹ thuật số trực tiếp trên máy.",
      "padnotesai.feat3_title": "Apple Intelligence",
      "padnotesai.feat3_desc": "Tóm tắt, lọc ý chính của ghi chú bằng mô hình LLM chạy trực tiếp offline trên thiết bị.",
      "padnotesai.feat4_title": "Voice Recorder",
      "padnotesai.feat4_desc": "Ghi âm các buổi họp, bài giảng trực tiếp và tích hợp văn bản ghi âm vào trang ghi chú.",
      "padnotesai.feat5_title": "iCloud Sync & Apple Sign-In",
      "padnotesai.feat5_desc": "Bảo mật tài khoản với Apple ID và đồng bộ tự động toàn bộ dữ liệu qua CloudKit.",
      "padnotesai.feat6_title": "Gemini Assistant",
      "padnotesai.feat6_desc": "Cấu hình API Key cá nhân để mở khóa trò chuyện chuyên sâu dựa trên toàn bộ nội dung trang.",
      "padnotesai.showcase_title": "Giao diện Workspace tối ưu.",
      "padnotesai.showcase_desc": "Bảng vẽ viết tay PencilKit đặt ngay cạnh cửa sổ AI Assistant để bạn vừa ghi chép vừa thảo luận tiện lợi.",
      "padnotesai.copyright": "&copy; 2026 Pham Hung Tien. Bảo lưu mọi quyền.",
    ...
    en: {
      ...
      "root.nav_products": "Products",
      "root.hero_eyebrow": "PHAM HUNG TIEN · APPLE SOFTWARE",
      "root.hero_title": "Small apps that make everyday things feel better.",
      "root.explore": "Explore products",
      "root.hero_contact": "Let's talk",
      "root.stat_products": "products",
      "root.stat_platforms": "Apple platforms",
      "root.stat_care": "care in the details",
      "root.featured_label": "NEW & NOTEWORTHY",
      "root.products_eyebrow": "THE COLLECTION",
      "root.products_title": "Find a tool that fits the way you work.",
      "root.products_desc": "Each product starts with a familiar problem, then makes it simpler, faster, and more pleasant to solve.",
      "root.view_product": "View product <span aria-hidden=\"true\">↗</span>",
      "root.category_utility": "UTILITY",
      "root.category_calendar": "CALENDAR & UTILITY",
      "root.category_macos": "macOS",
      "root.category_developer": "FOR DEVELOPERS",
      "root.category_productivity": "PRODUCTIVITY",
      "root.category_game": "GAME",
      "root.contact_eyebrow": "LET'S CONNECT",
      "root.contact_title": "Have an idea that deserves to become an app?",
      "root.contact_desc": "I'm always excited by thoughtful products that are useful, focused, and made with care.",
      "root.get_in_touch": "Get in touch",
      "root.visit_github": "Visit GitHub",
      ...
      "mynasmanager.download_btn": "Download on the App Store",
      ...
      "padnotesai.download_btn": "Download on App Store",
      ...
      "padnotesai.platforms": "Platforms",
      "padnotesai.execution": "Recognition",
      "padnotesai.on_device": "On-device OCR",
      "padnotesai.support": "Support",
      "padnotesai.support_title": "Support & Contact",
      "padnotesai.support_desc": "Have questions or need technical support for Pad Notes AI? Please reach out to us via email:",
      "padnotesai.features_kicker": "Key Features",
      "padnotesai.features_title": "A next-generation digital notebook.",
      "padnotesai.features_desc": "Handwrite notes, record audio, and visually analyze documents from anywhere.",
      "padnotesai.feat1_title": "Smart Handwriting",
      "padnotesai.feat1_desc": "Rich Pencil writing experience with customized brushes, color palettes, and template templates.",
      "padnotesai.feat2_title": "Local Handwriting OCR",
      "padnotesai.feat2_desc": "Scan and convert handwritten notes into digital text locally on your device.",
      "padnotesai.feat3_title": "Apple Intelligence",
      "padnotesai.feat3_desc": "Summarize and extract key points using on-device models running completely offline.",
      "padnotesai.feat4_title": "Voice Recorder",
      "padnotesai.feat4_desc": "Record meetings or lectures and sync transcripts directly into your note pages.",
      "padnotesai.feat5_title": "iCloud Sync & Sign-In",
      "padnotesai.feat5_desc": "Secure account access with Apple ID and seamless data sync across devices with CloudKit.",
      "padnotesai.feat6_title": "Gemini Assistant",
      "padnotesai.feat6_desc": "Use your custom Gemini API key to chat with and ask questions about your notebook's contents.",
      "padnotesai.showcase_title": "Optimized Workspace UI.",
      "padnotesai.showcase_desc": "A split-screen design putting PencilKit canvas next to the AI Assistant for seamless workflows.",
      "padnotesai.copyright": "&copy; 2026 Pham Hung Tien. All rights reserved.",
